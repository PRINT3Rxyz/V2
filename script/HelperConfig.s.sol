...
contract HelperConfig is IHelperConfig, Script {
    ...
    function getBaseSepoliaConfig() public returns (NetworkConfig memory baseSepoliaConfig) {
        ...
        baseSepoliaConfig.contracts.uniV3SwapRouter = address(0);
        baseSepoliaConfig.contracts.uniV3Factory = address(0);
        baseSepoliaConfig.contracts.uniV2Factory = address(0);
        baseSepoliaConfig.contracts.chainlinkFeedRegistory = address(0);
        baseSepoliaConfig.contracts.pyth = address(0);
        baseSepoliaConfig.subId = 0;
        baseSepoliaConfig.donId = keccak256(abi.encode("DON"));
        baseSepoliaConfig.contracts.chainlinkRouter = address(0);
    ...
    function getOrCreateAnvilConfig() public returns (NetworkConfig memory anvilConfig) {
        ...
        anvilConfig.contracts.chainlinkFeedRegistory = address(0);
