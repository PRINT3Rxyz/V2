...
A total of 80% of all fees generated are distributed to the `GlobalRewardTracker` contract. This singleton contract is responsible for determining rates of rewards, and distributing those rewards to liquidity providers.
